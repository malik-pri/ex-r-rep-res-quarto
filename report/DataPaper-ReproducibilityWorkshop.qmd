---
title: "Data Article: Trier social stress test and food-choice: Behavioral, self-report & hormonal data(data fluency change)"
...
#execute heading can be used in \_quarto.yml file as well.
...
![Timeline of the experiment](fig/Fig1.jpg){#fig-timeline fig-align="center"}
...
$$
\text Amount (fruit/vegetable) = - \frac{px}{py}  
Amount (\frac{sweet}{salty}) + \frac{m}{py}
$$ {#eq-budget}
...
Here's some <b>bold</b> test. \# HTML Code
...
# #df <- read_csv(here::here("output/data/preprocessed-GARP-TSST-data.csv")) # for rmarkdown solution
# 
# df <- read_csv("output/data/preprocessed-GARP-TSST-data.csv")
# 
...
# WE CAN DIRECTLY SOURCE THE CODE FROM OTHER FILE
